...
if ($page > 1 && $totalpages != 1) {
    $output .= '<li>
        <div class="prv-btn" sort="' . htmlspecialchars($sort) . '" search="' . htmlspecialchars($search) . '" lifestage="' . htmlspecialchars($lifestage) . '" type="' . htmlspecialchars($dvaluen) . '" pager="' . ($page - 1) . '">
...
if ($page > 3) {
    $output .= '<li class="pg-btn" style="padding:5px 6px; cursor: pointer" sort="' . htmlspecialchars($sort) . '" search="' . htmlspecialchars($search) . '" lifestage="' . htmlspecialchars($lifestage) . '" typevalue="' . htmlspecialchars($dvaluen) . '" pagerv="1">1</li>';
    if ($page > 4) {
...
for ($i = $startPage; $i <= $endPage; $i++) {
    $output .= '<li class="pg-btn ' . ($page == $i ? 'active' : '') . '" style="padding:5px 6px; cursor: pointer" sort="' . htmlspecialchars($sort) . '" search="' . htmlspecialchars($search) . '" lifestage="' . htmlspecialchars($lifestage) . '" typevalue="' . htmlspecialchars($dvaluen) . '" pagerv="' . $i . '">' . $i . '</li>';
}
...
if ($page < $totalpages - 2) {
    ...
    $output .= '<li class="pg-btn" style="padding:5px 6px; cursor: pointer" sort="' . htmlspecialchars($sort) . '" search="' . htmlspecialchars($search) . '" lifestage="' . htmlspecialchars($lifestage) . '" typevalue="' . htmlspecialchars($dvaluen) . '" pagerv="' . $totalpages . '">' . $totalpages . '</li>';
}

// "Next" button
if ($page < $totalpages) {
    $output .= '<li>
        <div class="next-btn" sort="' . htmlspecialchars($sort) . '" search="' . htmlspecialchars($search) . '" lifestage="' . htmlspecialchars($lifestage) . '" type="' . htmlspecialchars($dvaluen) . '" pager="' . ($page + 1) . '" tab="sdff' . $page . '">
...
if ($totalpages > 1) {
    $output .= '<p>
        <span>of&nbsp;</span>
        <span class="ng-binding">' . htmlspecialchars($totalpages) . '</span>
        <span>&nbsp;pages</span>
    </p>';
} else {
    $output .= '<p>
